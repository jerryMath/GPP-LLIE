...
class Decoder(nn.Module):
    def __init__(self, ch, out_ch, ch_mult, num_res_blocks, attn_resolutions, dropout, resamp_with_conv,
...
class Decoder2(nn.Module):
    def __init__(self, ch=128, out_ch=3, ch_mult=[1, 2, 4], num_res_blocks=2, attn_resolutions=[],
                 dropout=0.0, resamp_with_conv=True, in_channels=3, resolution=256, z_channels=3,
                 give_pre_end=False, tanh_out=False, use_linear_attn=False, attn_type="vanilla"):
        super().__init__()
        if use_linear_attn: attn_type = "linear"
        self.ch = ch
        self.temb_ch = 0
